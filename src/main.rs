...
fn main() -> Result<(), Box<dyn Error>> {
	...
	let root_composition_unloaded = UnloadedComposition::from_string(root_composition_string)?;
	...
	let root_composition = LoadedComposition::check(root_composition_unloaded)?;
